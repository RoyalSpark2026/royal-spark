      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#081226]/80 backdrop-blur-xl" data-testid="site-header">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4 md:px-10 lg:px-16">
          <NavLink to="/" className="flex items-center text-white" data-testid="brand-home-link">
            <div className="overflow-hidden rounded-[18px] border border-[#d8b85d]/18 bg-[linear-gradient(180deg,rgba(8,18,38,0.88),rgba(8,18,38,0.68))] px-1.5 py-1.5 shadow-[0_6px_24px_rgba(5,10,24,0.35)] backdrop-blur-sm" data-testid="header-logo-image-wrapper">
      ...
      <footer className="border-t border-white/10 bg-[#081226]/70" data-testid="site-footer">
        <div className="mx-auto grid max-w-7xl gap-6 px-6 py-10 md:grid-cols-3 md:px-10 lg:px-16">
          <div className="flex flex-col gap-4">
            <div className="w-fit overflow-hidden rounded-[20px] border border-[#d8b85d]/16 bg-[linear-gradient(180deg,rgba(8,18,38,0.72),rgba(8,18,38,0.52))] px-1.5 py-1.5 shadow-[0_4px_18px_rgba(5,10,24,0.28)] backdrop-blur-sm" data-testid="footer-logo-image-wrapper">
